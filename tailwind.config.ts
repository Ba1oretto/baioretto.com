...
export default {
  ...
  theme: {
    colors: {
      ...
      "dusky-gray": "hsl(215 8% 47%)",
      "charcoal-gray": "hsl(212 12% 21%)",
      "dark-gray": "hsl(0 0% 17%)",
      "forest-green": "hsl(123 41% 45%)",
      "seaweed-green": "hsl(149 62% 39%)",
      "emerald-green": "hsl(132 59% 33%)",
      "light-midnight-blue": "hsl(220 100% 50%)",
      "azure": "hsl(202 83% 45%)",
    ...
    extend: {
      ...
      boxShadow: {
        "aureole-gray": "inset 0 0 0 1px #30363d",
        "aureole-blue-highlight": "inset 0 0 0 3px hsla(220,100%,50%,80%)",
